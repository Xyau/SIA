...
public class RandomBiasedSquaredSelector extends BaseSelector implements Selector {
    private Random random;
    public RandomBiasedSquaredSelector(Integer selectedIndividuals, Random random) {
